<template>
  <div class="error-box" id="error-box">
    <link rel="stylesheet"
          href="http://static.parastorage.com/services/santa-resources/resources/viewer/user-site-fonts/v3/helvetica.css"
          type="text/css"/>
    <div class="container">
      <svg class="image-404" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 429.4 301.63">
        ...
        <path d="M109.65 254.16a3.94 3.94 0 0 0 3.6-5.02 17.14 17.14 0 0 0-33 .06 3.9 3.9 0 0 0 3.6 4.96z"
              class="cls-7"/>
        <path d="M109.65 254.16a3.94 3.94 0 0 0 3.6-5.02 17.14 17.14 0 0 0-33 .06 3.9 3.9 0 0 0 3.6 4.96z"
              class="cls-7"/>
        <path d="M106.83 254.16a3.08 3.08 0 0 0 2.83-3.92 13.4 13.4 0 0 0-25.8.04 3.04 3.04 0 0 0 2.82 3.88z"
              class="cls-8"/>
      ...
      <div class="not-found">找不到页面</div>
      <div class="description">请确认您输入的网址是否正确</div>
